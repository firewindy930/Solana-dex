...
;
const metadata = {
    title: "SolaMeme - Solana Meme Coin DEX",
    description: "The most fun and vibrant decentralized exchange for Solana meme coins. Trade, discover, and launch your meme coins with style.",
    generator: "v0.app",
    icons: {
        icon: [
            {
